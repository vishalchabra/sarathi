...
export default function AscendantCard({
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="rounded-2xl border border-[color:var(--border)] bg-white/80 shadow-sm p-6">
        ...
        <div className="mb-6">
          ...
          <div className="text-slate-900 text-base mt-3 leading-relaxed">
            <div className="mb-2">
        ...
        {panchang && (
          <div className="border-t border-[color:var(--border)] pt-6">
            ...
            <dl className="grid grid-cols-1 md:grid-cols-2 gap-y-2 text-sm text-slate-900/80">
              <div>
                <dt className="font-medium text-slate-900/90">Weekday</dt>
                <dd>{panchang.weekday}</dd>
              </div>

              <div>
                <dt className="font-medium text-slate-900/90">Tithi</dt>
                <dd>{panchang.tithiName}</dd>
              </div>

              <div>
                <dt className="font-medium text-slate-900/90">Yoga</dt>
                <dd>{panchang.yogaName}</dd>
              </div>

              <div>
                <dt className="font-medium text-slate-900/90">
                  Moon’s Nakshatra
                </dt>
                <dd>
              ...
              {panchang.rahuKaal && (
                <div>
                  <dt className="font-medium text-slate-900/90">Rahu Kaal</dt>
              ...
              {panchang.gulikaKaal && (
                <div>
                  <dt className="font-medium text-slate-900/90">Gulika Kaal</dt>
