...
export default function SarathiHome() {
  return (
    <main className="astro-bg min-h-screen text-slate-800">
      {/* Background glow */}
      ...
      {/* Top nav */}
      <header className="sticky top-0 z-40 border-b border-[color:var(--border)] bg-[#fbf7ef]/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm text-slate-900 md:flex">
            ...
            <Link className="hover:text-slate-900" href="/sarathi/faqs">
              FAQs
            </Link>
  ...
  Sārathi Astrologer’s Desk
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="rounded-full bg-[color:var(--primary)] px-4 py-2 text-sm font-semibold text-slate-900 shadow-[0_0_0_1px_rgba(255,255,255,0.08)_inset] hover:opacity-90"
            >
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10 pt-10 md:pt-14">
        <div className="grid gap-10 md:grid-cols-2 md:items-start">
          ...
          <div>
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-slate-900">
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3">
              <Link
                href="/sarathi/chat"
                className="rounded-full bg-[color:var(--primary)] px-5 py-2.5 text-sm font-semibold text-slate-900 hover:opacity-90"
              >
              ...
              <Link
                href="#start"
                className="rounded-full astro-card px-5 py-2.5 text-sm font-semibold text-slate-900/90 hover:bg-white/80 hover:shadow-md"
              >
                Explore Sārathi
              </Link>
          ...
          <div className="rounded-2xl astro-card p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.06)_inset]">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold text-slate-900/90">
...
<section className="mx-auto max-w-6xl px-4 pb-16">
  <div className="grid gap-6 md:grid-cols-2">
    ...
    <div className="rounded-2xl astro-card p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.06)_inset]">
      ...
      <h2 className="mt-2 text-xl font-semibold text-slate-900/90">
      ...
      <div className="mt-4 rounded-xl astro-card p-4 text-sm text-slate-900">
        <span className="text-slate-900/80">Promise:</span> The point isn’t
    ...
    <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
      <div className="max-w-3xl">
        ...
        <div className="mt-4 text-sm text-slate-900">
          ...
          <span className="text-slate-900/85 font-semibold">
      ...
      <div className="flex shrink-0 flex-wrap gap-3">
        <a
          href="/sarathi/about"
          className="rounded-full astro-card px-4 py-2 text-sm font-semibold text-slate-900/85 hover:bg-white/80 hover:shadow-md"
        >
          Read the full story →
        </a>
        <a
...
/>
        ...
        <footer className="mt-14 border-t border-[color:var(--border)] pt-6 text-xs text-slate-900">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link className="hover:text-slate-900" href="/faqs">
                FAQs
              </Link>
              <Link className="hover:text-slate-900" href="/sarathi/privacy">
                Privacy
...
function Step({
  ...
  return (
    <div className="flex gap-4">
      <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white text-xs font-semibold text-slate-900 ring-[color:var(--border)]">
        {n}
      </div>
      <div>
...
const accentMap = {
  ...
  return (
    <div className="rounded-2xl astro-card p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.06)_inset]">
      ...
      <p className="mt-4 text-sm leading-relaxed text-slate-900">{desc}</p>

      <div className="mt-6">
        <Link
          href={href}
          className="inline-flex items-center rounded-full astro-card px-4 py-2 text-sm font-semibold text-slate-900/85 hover:bg-white/80 hover:shadow-md"
        >
          {cta}
        </Link>
      </div>
