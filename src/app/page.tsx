...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50">
      ...
      {/* Main content */}
      <main className="mx-auto flex max-w-6xl flex-col gap-14 px-4 pb-16 pt-8 md:pt-12">
        {/* Hero */}
          ...
          <Card className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm">
            ...
            <CardContent className="pt-6">
              <div className="grid gap-8 md:grid-cols-2">
                ...
                <div
                  id="my-story"
                  className="scroll-mt-24 rounded-2xl border border-white/10 bg-slate-950/40 p-6 leading-relaxed"
                >
